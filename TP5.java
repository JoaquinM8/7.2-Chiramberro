...
public class TP5 extends JFrame {
    ...
    private JPanel menu() {
        ...
        JLabel lblTitulo = new JLabel("TP 5 - PROGRAMAS", SwingConstants.CENTER);
        ...
        for (int i = 1; i <= 15; i++) {
            int ejercicio = i;
            String nombre = "Ejercicio 5." + i;
            JButton button = new JButton(nombre);
            button.addActionListener(e -> {
                setTitle("TP 5 - " + nombre);
    ...
    private JPanel crearEjercicio(int ejercicio) {
        switch (ejercicio) {
            case 1:
                return new ejercicio5_1();
            case 2:
                return new ejercicio5_2();
            case 3:
                return new ejercicio5_3();
            case 4:
                return new ejercicio5_4();
            case 5:
                return new ejercicio5_5();
            case 6:
                return new ejercicio5_6();
            case 7:
            ...
            case 10:
                return new ejercicio5_10();
            case 11:
                return new ejercicio5_11();
            case 12:
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(TP5::new);
    }
}
