...
public class ejercicio4_4 extends JPanel {

    public ejercicio4_4() {
        JLabel titleLabel = new JLabel("MAXIMO DE 2 NUMEROS", SwingConstants.CENTER);
        ...
        submitButton.addActionListener(e -> {
            try {
                ...
                resultLabel.setText("Mayor: " + maximo(a, b));
    ...
    private static void mostrarEnVentana() {
        JFrame frame = new JFrame("Ejercicio 4.4");
        frame.setSize(520, 220);
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        frame.setLocationRelativeTo(null);
        frame.add(new ejercicio4_4());
        frame.setVisible(true);
    }

    public static void main(String[] args) {
        SwingUtilities.invokeLater(ejercicio4_4::mostrarEnVentana);
    }
}
